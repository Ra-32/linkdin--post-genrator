...
def extract_metadata(post):
    ...
    4. Language should be English or Hinglish,Hinglish means Hindi words written in English script mixed with English.
    5. If NO Hindi words are present, language MUST be English.
